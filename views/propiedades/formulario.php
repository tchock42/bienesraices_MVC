<fieldset>
            ...
            <fieldset>
                ...
                <label for="vendedor">Vendedor</label> <!--el for=vendedor es para el id=vendedor siguiente-->
                <select name="propiedad[vendedores_id]" id="vendedor"> <!--lleva el name el nombre de la columna en la tabla de sql y el objeto-->
                    <option selected value=""> --Seleccione-- </option>
                    <?php foreach ($vendedores as $vendedor){ ?>
                        <option 
                            <?php echo $propiedad->vendedores_id === $vendedor->id ? 'selected' : ''; ?>
                        value="<?php echo s($vendedor->id); ?>" ><?php echo s($vendedor->nombre) . " " . s($vendedor->apellido); ?> </option> <!-- s es para escapar el texto. vendedor->apellido accede al atributo apellido -->
                    <?php } ?>
                </select>
            </fieldset>